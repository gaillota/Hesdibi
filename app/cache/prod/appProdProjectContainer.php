...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b->addEventSubscriber($this->get('stof_doctrine_extensions.listener.blameable'));
        $b->addEventSubscriber($this->get('stof_doctrine_extensions.listener.uploadable'));
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'vault', 'user' => 'root', 'password' => '6Es5DnXNaC', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    {
        require_once (__DIR__.'/jms_diextra/doctrine/EntityManager_5616b1689ad2e.php');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5616b1689ad2e_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_5e29824ff5e6c6ffe11d15cd3fbe8cb82bf31516ad3c7e370bafba36aa4650f1');
        return $instance;
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5616b1686c3312.97135527'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5616b1686c3312.97135527'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'main', $this->get('security.encoder_factory'), true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '37c5fccda23023457106071114a0fb29482e8f2f', 'main')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => (__DIR__.'/jms_diextra/doctrine/EntityManager_5616b1689ad2e.php'),
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5616b1689ad2e_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
