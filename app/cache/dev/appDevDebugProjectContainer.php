...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'ag_vault.date_fr_extension' => 'getAgVault_DateFrExtensionService',
            'ag_vault.font_awesome_extension' => 'getAgVault_FontAwesomeExtensionService',
            'ag_vault.size_reformat_extension' => 'getAgVault_SizeReformatExtensionService',
            ...
            'security.firewall.map.context.access_file' => 'getSecurity_Firewall_Map_Context_AccessFileService',
    ...
    /**
     * Gets the 'ag_vault.date_fr_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AG\VaultBundle\Twig\DateFrExtension A AG\VaultBundle\Twig\DateFrExtension instance.
     */
    protected function getAgVault_DateFrExtensionService()
    {
        return $this->services['ag_vault.date_fr_extension'] = new \AG\VaultBundle\Twig\DateFrExtension();
    }

    /**
     * Gets the 'ag_vault.font_awesome_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AG\VaultBundle\Twig\FontAwesomeExtension A AG\VaultBundle\Twig\FontAwesomeExtension instance.
     */
    protected function getAgVault_FontAwesomeExtensionService()
    {
        return $this->services['ag_vault.font_awesome_extension'] = new \AG\VaultBundle\Twig\FontAwesomeExtension();
    }

    /**
     * Gets the 'ag_vault.size_reformat_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AG\VaultBundle\Twig\SizeReformatExtension A AG\VaultBundle\Twig\SizeReformatExtension instance.
     */
    protected function getAgVault_SizeReformatExtensionService()
    {
        return $this->services['ag_vault.size_reformat_extension'] = new \AG\VaultBundle\Twig\SizeReformatExtension();
    }
    ...
    {
        $this->services['assetic.filter.less'] = $instance = new \Assetic\Filter\LessFilter('node', array(0 => ($this->targetDirs[2].'\\..\\node_modules')));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber($this->get('stof_doctrine_extensions.listener.blameable'));
        $d->addEventSubscriber($this->get('stof_doctrine_extensions.listener.uploadable'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'vault', 'user' => 'root', 'password' => '6Es5DnXNaC', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $d, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \EntityManager5616803cab8d9_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager5616803cab8d9_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once (__DIR__.'/jms_diextra/doctrine/EntityManager_5616803cab8d9.php');
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AG/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/AG/VaultBundle/Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'FOS\\UserBundle\\Entity');
        $d->addDriver($c, 'AG\\UserBundle\\Entity');
        $d->addDriver($c, 'AG\\VaultBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'AGUserBundle' => 'AG\\UserBundle\\Entity', 'AGVaultBundle' => 'AG\\VaultBundle\\Entity'));
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager5616803cab8d9_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_231e0db46136412dd4598bdf250285ca917f532b6078f1a093af28159b7b4a5b');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('AG\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('AG\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'AG\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['jms_di_extra.metadata_driver'] = new \JMS\DiExtraBundle\Metadata\Driver\ConfiguredControllerInjectionsDriver(new \JMS\DiExtraBundle\Metadata\Driver\AnnotationDriver($this->get('annotation_reader'), $this->get('jms_di_extra.service_naming_strategy')), array('request' => new \Symfony\Component\DependencyInjection\Reference('request'), 'em' => new \Symfony\Component\DependencyInjection\Reference('doctrine.orm.entity_manager'), 'paginator' => new \Symfony\Component\DependencyInjection\Reference('knp_paginator'), 'flash' => new \Symfony\Component\DependencyInjection\Reference('braincrafted_bootstrap.flash')), array());
    }
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'KnpPaginatorBundle:Pagination:sliding.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 7));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.access_file' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/file/[a-z0-9]{40}'), 'security.firewall.map.context.main_login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/login$'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'security.firewall.map.context.access_file' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_Firewall_Map_Context_AccessFileService()
    {
        $a = $this->get('security.token_storage');
        $b = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        return $this->services['security.firewall.map.context.access_file'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('fos_user.user_provider.username')), 'access_file', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5616803c56a0c9.33300914', $b, $this->get('security.authentication.manager')), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'access_file', NULL, NULL, NULL, $b, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), '37c5fccda23023457106071114a0fb29482e8f2f', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'main', $c, $d), 2 => $i, 3 => $l, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d, true), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'fos_user_security_login', false), NULL, NULL, $c, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('ag_vault.font_awesome_extension'));
        $instance->addExtension($this->get('ag_vault.date_fr_extension'));
        $instance->addExtension($this->get('ag_vault.size_reformat_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/AG/UserBundle/Resources/views'), 'AGUser');
        $instance->addPath(($this->targetDirs[3].'/src/AG/VaultBundle/Resources/views'), 'AGVault');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('37c5fccda23023457106071114a0fb29482e8f2f');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/file$'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5616803c56a0c9.33300914'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5616803c56a0c9.33300914'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'main', $this->get('security.encoder_factory'), true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '37c5fccda23023457106071114a0fb29482e8f2f', 'main')), true);
    ...
    protected function getStofDoctrineExtensions_Listener_UploadableService()
    {
        ...
        $instance->setDefaultPath(($this->targetDirs[2].'/../web/uploads/files'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AGUserBundle' => 'AG\\UserBundle\\AGUserBundle',
                'AGVaultBundle' => 'AG\\VaultBundle\\AGVaultBundle',
            ...
            'database_name' => 'vault',
            'database_user' => 'root',
            'database_password' => '6Es5DnXNaC',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '37c5fccda23023457106071114a0fb29482e8f2f',
            'mailgun_api_key' => 'key-5a35cc03e70b3be9a12404cc707f9138',
            'domain_name' => 'antoine-gaillot.com',
            'locale' => 'fr',
            ...
            'kernel.secret' => '37c5fccda23023457106071114a0fb29482e8f2f',
            ...
            'fos_user.model.user.class' => 'AG\\UserBundle\\Entity\\User',
            ...
            'jms_di_extra.doctrine_integration.entity_manager.file' => (__DIR__.'/jms_diextra/doctrine/EntityManager_5616803cab8d9.php'),
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager5616803cab8d9_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'stof_doctrine_extensions.default_file_path' => ($this->targetDirs[2].'/../web/uploads/files'),
